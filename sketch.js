...
function setup() {
  ...
  world = engine.world;
  ground = new Ground(750, 375, 1500, 25);
...
function draw() {
  ...
  box6.display("lightblue", "pink");
  box7.display("lightblue", "pink");
  box8.display("lightblue", "pink");
  box9.display("lightblue", "pink");
  ...
  fill("red");
  stroke(4);
  text("Drag the ball and release it to hit the blocks", 150, 385)
  fill("purple");
  textSize(15);
  stroke(4);
  text("Please press space to play for the 2nd time",20,30)
}
